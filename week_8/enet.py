from tensorflow.keras.layers import SpatialDropout2D, Permute, Activation, Reshape, Input
from tensorflow.keras.layers import add, concatenate
from tensorflow.keras.layers import MaxPooling2D, Conv2D, Conv2DTranspose, UpSampling2D, ZeroPadding2D, PReLU, BatchNormalization
...
def bottleneck(inp, output, internal_scale=4, asymmetric=0, dilated=0, downsample=False, dropout_rate=0.1):
    ...
    encoder = BatchNormalization(momentum=0.1)(encoder)  # enet uses momentum of 0.1, tensorflow.keras default is 0.99
...
def en_build(inp, dropout_rate=0.01):
    ...
    enet = BatchNormalization(momentum=0.1)(enet)  # enet_unpooling uses momentum of 0.1, tensorflow.keras default is 0.99
